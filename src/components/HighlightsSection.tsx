...
const HighlightsSection = () => (
  <section className="py-16 bg-vendel-warm">
    <div className="container mx-auto px-4">
      <p className="font-cursive text-vendel-rose text-2xl text-center mb-2">Why Vendel?</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {highlights.map((h) => (
          ...
          >
            <div className="w-14 h-14 rounded-full bg-vendel-rose/15 flex items-center justify-center mx-auto mb-4">
              <h.icon className="h-7 w-7 text-vendel-rose" />
            </div>
